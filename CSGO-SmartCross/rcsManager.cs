...
namespace CSGO_SmartCross
{
    class RcsManager
    {
        ...
        public RcsManager(Vector vector, Point screenSize){
        ...
        public void start()
        {
            ...
            while (running)
            {
                ...
                float x = screenToMouseX(vector.x);
                float y = screenToMouseY(vector.y);
        ...
        //back-calculates the mouse movement needed based on a crosshair movement
        //screen is crosshair's position on the screen
        private int screenToMouseX(float x){
            int mouse = 0;
            //double vecX = ((double)screen - (double)(screenSize.X / 2)) / (-21.333333333);
            mouse = (int)((x - prevVecX) / (vecToMouse));
            prevVecX = x;
            return mouse;
        }
        ...
        //back-calculates the mouse movement needed based on a crosshair movement
        //screen is crosshair's position on the screen
        private int screenToMouseY(float y){
            int mouse = 0;
            //double vecY = ((double)screen - (double)(screenSize.Y / 2)) / (12);
            mouse = (int)((y - prevVecY) / (vecToMouse));
            prevVecY = y;
            return -mouse;
        }
